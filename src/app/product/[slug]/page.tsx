...
import { CATEGORIES, TINTS, cn, formatNumber } from "@/lib/utils";
    ...
    <>
      <section className="relative overflow-hidden pb-20 pt-40 md:pt-48">
        <div className="absolute inset-0 -z-10">
          ...
          <div className="absolute -top-24 end-[12%] size-[340px] rounded-full bg-accent/10 blur-[110px]" />
        </div>
            ...
            <Reveal className="lg:sticky lg:top-28 lg:self-start">
              <TiltCard intensity={6} glare={false}>
                <div className="relative overflow-hidden rounded-[2.5rem] border border-neutral-200/80 bg-neutral-950 p-10 text-white dark:border-white/10 dark:bg-neutral-900">
                  ...
                  <div className="absolute -top-20 -start-20 size-64 rounded-full bg-accent/25 blur-[90px]" />
                  ...
                  <div className="relative">
                    ...
                    {p.imageUrl ? (
                      ...
                      <div className="relative mx-auto my-12 grid size-48 place-items-center">
                        ...
                        <span className="absolute inset-4 animate-spin-slow rounded-full border border-dashed border-white/20" />
                        <span
