      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute end-0 top-[calc(100%+10px)] z-50 w-64 overflow-hidden rounded-3xl border border-neutral-200 bg-white p-2 shadow-2xl dark:border-neutral-800 dark:bg-neutral-900"
          >
