...
function AnimatedMoney({ value }: { value: number }) {
  ...
  useEffect(() => {
    const unsub = spring.on("change", (v) => {
      if (ref.current) ref.current.textContent = formatMoney(v);
    });
    return unsub;
  }, [spring]);
          ...
          <div className="relative p-5 sm:p-7">
            ...
            <div className="relative z-10 -my-4 flex justify-center">
              <motion.button
                ...
                className="grid size-12 place-items-center rounded-full border-4 border-white bg-accent text-white shadow-xl shadow-accent/40 transition hover:scale-110 dark:border-neutral-900"
              >
